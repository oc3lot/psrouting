...
#Date			Who					Comment													#
#-------------	------------------	------------------------------------------------------	#
#28Jul2016		Kelvin Hoyle		Created to quickly create document routing rules        #
#                                   for 'Assessments' Record Library                        #
#									                                    					#
#############################################################################################
...
#Return Value: N/A																			#
#Purpose: Inserts new document routing rules for 'Assessments' RC                       	#
#############################################################################################
...
$RecordCenterURL = "http://infoctr/ic_assess/"
